...
public class OpenApiConfiguration {
    @Bean OpenAPI bankingOpenApi(AppProperties properties) {
        AppProperties.OpenApi openApi = properties.getOpenapi();
        return new OpenAPI().info(new Info().title(openApi.getTitle()).version(openApi.getVersion())
